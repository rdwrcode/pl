...
val test802 = all_answers (fn x => if x mod 2 = 0 then SOME [x] else NONE) [2,4,5,6,8] = SOME [2, 4, 6, 8]
...
val test805 = all_answers (fn x => if x mod 2 = 0 then SOME [x-1] else NONE) [2,4,6,8] = SOME [1,3,5,7]

val test806 = all_answers (fn x => if x mod 2 = 0 then SOME [x] else NONE) [] = NONE
...
val test9c02 = count_some_var ("x", (TupleP [Wildcard, Variable "str", Wildcard])) = 1
